...
import { service1, service2, service3, check, recording03, recording01, disc02, chromecast, sliders04 } from '../assets'
            ...
            <div className='container'>
                ...
                <div className='relative'>
                    ...
                    rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]'>
                        ...
                        <div className='relative z-1 md:max-w-[17rem] ml-auto'>
                            ...
                            <ul className='body-2'>
                                {BRAINWAVESERVICES.map((item, index) => (
                                    <li key={index} className='body-2 flex items-start gap-4 py-4 border-t border-n-6'>
                        ...
                        <Generating className='absolute left-4 right-4 bottom-4 border-n-1/10 border lg:left-1/2  lg:bottom-8 
                        lg:-translate-x-1/2' />
                    </div>
