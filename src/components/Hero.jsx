        ...
        <Section id='hero' className='pt-[12rem] -mt-[5.25]'>
            ...
            <div className='container relative z-1' ref={parallexRef}>
                ...
                <div className='relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6rem]'>
                    <h1 className='h1 mb-6'>Explore the Possibility of&nbsp;AI&nbsp;Chatting with {' '}
                        <span className='inline-block relative'>Brainwave
                            <img src={curve} className='absolute top-full left-0 w-full xl:-m-2' alt="curve" width={624} height={28} />
                        </span>
                    </h1>
                ...
                <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
                    ...
                    <div className="absolute -top-[54%] left-1/2 w-[234%] -translate-x-1/2 md:-top-[46%] md:w-[138%] lg:-top-[137%]">
                        <img
                            src={heroBackground}
                            className="w-full"
                            width={1440}
